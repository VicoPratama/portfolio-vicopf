                    ...
                    <div className="lg:col-span-8 space-y-24 pb-24">
                            ...
                            <div className="space-y-16">
                                {experience.map((job, index) => (
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-300 leading-relaxed whitespace-pre-line border-l-2 border-gray-800 pl-6 group-hover:border-white transition-colors">
                                            {job.description}
                                        </p>
                                    </motion.div>
                                ))}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {certificates.map((cert, index) => (
                                    <motion.div
                                        ...
                                        viewport={{ once: true }}
                                        transition={{ delay: index * 0.1 }}
                                        className="bg-gray-900/40 backdrop-blur-xl border border-white/5 p-8 rounded-[2rem] hover:bg-gray-800/40 hover:border-white/20 hover:shadow-2xl transition-all duration-300 group"
                                    >
                                        ...
                                        {cert.description && <p className="text-sm text-gray-500 font-light border-t border-white/5 pt-4 mt-2">{cert.description}</p>}
                                    </motion.div>
                                ))}
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                {/* Programming */}
                                <div className="md:col-span-2 bg-gray-900/40 backdrop-blur-xl border border-white/10 p-8 rounded-[2rem] shadow-xl">
                                    <div className="flex items-center gap-3 mb-8">
                                        <div className="p-3 bg-white/5 rounded-xl border border-white/5">
                                            <Code className="text-white w-6 h-6" />
                                        </div>
                                        <h3 className="text-xl font-bold font-display tracking-tight">Programming</h3>
                                    </div>
                                ...
                                {/* Design */}
                                <div className="bg-gray-900/40 backdrop-blur-xl border border-white/10 p-8 rounded-[2rem] shadow-xl hover:bg-gray-800/40 transition-colors">
                                ...
                                {/* Languages & Tools */}
                                <div className="md:col-span-2 bg-gray-900/40 backdrop-blur-xl border border-white/10 p-8 rounded-[2rem] shadow-xl hover:bg-gray-800/40 transition-colors">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div>
                                            <div className="flex items-center gap-3 mb-6">
                                                <div className="p-3 bg-white/5 rounded-xl border border-white/5">
